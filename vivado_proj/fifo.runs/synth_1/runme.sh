...
HD_PWD='/home/mlyue/Documents/FPGA_A7/FIFO/vivado_proj/fifo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dcfifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dcfifo.tcl
